...
> **Current Windows build:** `1.0.0-beta.23` · [**Download Setup**](https://github.com/WheresWellium/StreamClip/releases/latest/download/qClip-Setup-win-x64.exe) (~521 MB, unsigned)  
> **Mac (Apple Silicon):** [**qClip-mac-arm64.dmg**](https://github.com/WheresWellium/StreamClip/releases/latest/download/qClip-mac-arm64.dmg) (`1.0.0-beta.23`, unsigned)
...
**Call to action (Apple Silicon):** [Download qClip-mac-arm64.dmg](https://github.com/WheresWellium/StreamClip/releases/latest/download/qClip-mac-arm64.dmg) (`1.0.0-beta.23`, same code as Windows Latest).
