...
**Download / installer:** **v1.0.0-beta.8** — see [`BETA_DOWNLOAD.md`](BETA_DOWNLOAD.md). Windows builds are **unsigned** until EV Authenticode (MASTER §4.10 / GAP O11) — SmartScreen “More info → Run anyway”.
