...
**Call to action:** [Download qClip-mac-arm64.dmg](https://github.com/WheresWellium/StreamClip/releases/latest/download/qClip-mac-arm64.dmg) (`1.0.0-beta.27`) → Applications → right-click **Open** (unsigned) → **Settings → License**. Same code train as Windows Latest.
...
**Call to action:** [Download Latest](https://github.com/WheresWellium/StreamClip/releases/latest/download/qClip-Setup-win-x64.exe) (`1.0.0-beta.27`)
